...
COMPILED_SRCS += \
./includes/application/Appscheduling.src \
./includes/application/Audio.src \
./includes/application/Driver_Stm.src \
./includes/application/Finger_Detector.src \
./includes/application/Foot_Sensor.src \
./includes/application/GTM_TOM_PWM.src \
./includes/application/LPF.src \
...
C_DEPS += \
./includes/application/Appscheduling.d \
./includes/application/Audio.d \
./includes/application/Driver_Stm.d \
./includes/application/Finger_Detector.d \
./includes/application/Foot_Sensor.d \
./includes/application/GTM_TOM_PWM.d \
./includes/application/LPF.d \
...
OBJS += \
./includes/application/Appscheduling.o \
./includes/application/Audio.o \
./includes/application/Driver_Stm.o \
./includes/application/Finger_Detector.o \
./includes/application/Foot_Sensor.o \
./includes/application/GTM_TOM_PWM.o \
./includes/application/LPF.o \
...
includes/application/%.src: ../includes/application/%.c includes/application/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc27xd "-fC:/Users/user/Downloads/AutoDoor-main (1)/AutoDoor-main/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -Y0 -N0 -Z0 -o "$@" "$<" && \
...
includes/application/Appscheduling.o: ./includes/application/Appscheduling.src includes/application/subdir.mk
	@echo 'Building file: $<'
...
includes/application/Driver_Stm.o: ./includes/application/Driver_Stm.src includes/application/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
includes/application/GTM_TOM_PWM.o: ./includes/application/GTM_TOM_PWM.src includes/application/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
includes/application/LPF.o: ./includes/application/LPF.src includes/application/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: TASKING Assembler'
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
	@echo 'Finished building: $<'
...
clean-includes-2f-application:
	-$(RM) ./includes/application/Appscheduling.d ./includes/application/Appscheduling.o ./includes/application/Appscheduling.src ./includes/application/Audio.d ./includes/application/Audio.o ./includes/application/Audio.src ./includes/application/Driver_Stm.d ./includes/application/Driver_Stm.o ./includes/application/Driver_Stm.src ./includes/application/Finger_Detector.d ./includes/application/Finger_Detector.o ./includes/application/Finger_Detector.src ./includes/application/Foot_Sensor.d ./includes/application/Foot_Sensor.o ./includes/application/Foot_Sensor.src ./includes/application/GTM_TOM_PWM.d ./includes/application/GTM_TOM_PWM.o ./includes/application/GTM_TOM_PWM.src ./includes/application/LPF.d ./includes/application/LPF.o ./includes/application/LPF.src ./includes/application/Light.d ./includes/application/Light.o ./includes/application/Light.src ./includes/application/Lock.d ./includes/application/Lock.o ./includes/application/Lock.src ./includes/application/Obstacle_Detector.d ./includes/application/Obstacle_Detector.o ./includes/application/Obstacle_Detector.src ./includes/application/Side_Door.d ./includes/application/Side_Door.o ./includes/application/Side_Door.src ./includes/application/Touch_Sensor.d ./includes/application/Touch_Sensor.o ./includes/application/Touch_Sensor.src
