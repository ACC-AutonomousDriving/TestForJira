...
void Driver_Stm_Init(void){
    ...
    g_Stm.stmConfig.triggerPriority = 100u; // 인터럽트 우선순위.
    g_Stm.stmConfig.typeOfService = IfxSrc_Tos_cpu0; // cpu0 번에게 알려줘.
    g_Stm.stmConfig.ticks = 100000u; // 100,000번 Counting 했을 때 : 1ms
...
void STM_Int0Handler(void){
    ...
    if((u32nuCounter1ms % 5000) == 0u){ // 5000ms
